...
\begin{frame}[shrink=18]{Server code}
...
\begin{frame}[shrink=18]{Server code, modified for active monitoring (1)}
...
\begin{frame}[shrink=18]{Server code, modified for active monitoring (2)}
...
\begin{frame}[shrink=18]{Server code, modified for passive monitoring}
...
\begin{frame}[shrink=18]{Monitor code, for passive monitoring}
