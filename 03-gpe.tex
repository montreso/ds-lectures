...
\begin{figure} 
\includegraphics[width=11cm]{diagram1}
\end{figure}	
...
\begin{figure} 
\includegraphics[width=11cm]{diagram2}
\end{figure}
\end{frame}
...
\BIL
\item Many problems in distributed systems require a reaction when the 
  global state of the system satisfies some condition.
  \BI
...
\begin{figure} 
\includegraphics[width=11cm]{gpe}
\end{figure}
...
\begin{figure} 
\includegraphics[width=11cm]{diagram3}
\end{figure}
...
\item Server executes method; may invoke methods on other
...
\begin{figure}
\includegraphics[width=10cm]{diagram3}
\end{figure}
...
\begin{definition}[Clock Condition]

\[ e \rightarrow e' \Rightarrow \LC(e) < \LC(e')  \]

\end{definition}

\begin{definition}[Strong Clock Condition]
...
\BI
\item Lamport's \alert{scalar} logical clock is a monotonically increasing software counter
...
\begin{figure} 
\includegraphics[width=11cm]{diagram4}
\end{figure}
...
\begin{theorem}
Scalar logical clocks \emph{satisfy} Clock condition, i.e.
\[
  e \rightarrow e' \Rightarrow LC(e) < LC(e')
\]
\end{theorem}
...
\begin{theorem}
Scalar logical clocks \emph{do not satisfy} Strong clock condition, i.e.
\[
...
\begin{figure} 
\includegraphics[width=9cm]{diagram4}
\end{figure}
...
\begin{theorem}
Causal histories \emph{satisfy} Strong clock condition
\end{theorem}
...
\begin{figure} 
\includegraphics[width=10cm]{diagram6}
\end{figure}
\end{frame}
...
\begin{frame}{Example}
\begin{figure} 
\includegraphics[width=11cm]{diagram5}
\end{figure}
\end{frame}
...
\begin{figure} 
\includegraphics[width=10cm]{diagram5}
\end{figure}
...
\begin{figure} 
\includegraphics[width=11cm]{diagram7}
\end{figure}
...
% \]
% \begin{figure} 
% \includegraphics[width=9cm]{figure-7}
% \end{figure}
% \end{frame}
...
\structure{Two conditions to be verified to check if $m$ can be delivered}:
...
\begin{figure} 
\includegraphics[width=10cm]{diagram8}
\end{figure}
\end{frame}
...
\structure{Liveness} The empty messages at 3.2 guarantee liveness.
...
\begin{frame}{Example}
\begin{figure} 
\includegraphics[width=9cm]{diagram9}
\end{figure}
\end{frame}
...
\begin{block}{Problem}
\BI
\item Let $\Sigma$ be a global state built by one of the presented methods
...
\begin{frame}
\begin{figure} 
\includegraphics[width=9.5cm]{figure-3}
\end{figure}
\end{frame}
...
\begin{figure} 
\includegraphics[width=11cm]{figure-16}
\end{figure}
\end{frame}
...
\BI
\item \bibentry{ozalp93consistent}
\EI
