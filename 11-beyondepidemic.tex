...
\REPEAT{every $\Delta$ time units}{
 $\ss\ q \gets \SelectNeighbor(\View)$\Comment*[f]{Select a random neighbor}\;
...
\begin{figure}
\multiinclude[graphics={width=0.60\textwidth},start=0,format=png]{ring-fingers}
\end{figure}
...
\begin{figure}	
\multiinclude[graphics={width=0.80\textwidth},start=0,format=png]{tchord}	
\end{figure}
...
%-------------------------------------------------------------------------
\begin{frame}[shrink=5]{Aggregation}
...
\begin{figure}
\includegraphics[width=0.80\textwidth]{newscast-sudden-epoch}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.80\textwidth]{newscast-dynamic}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.80\textwidth]{multiple-crash-original}
\end{figure}

\note{Network size estimation with multiple instance. Network size is $100\,000$, $1000$ nodes 
crash at the beginning of each cycle.
...
\begin{frame}{Multiple executions - churn}
\begin{figure}
\includegraphics[width=0.80\textwidth]{multiple-omission-original}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\textwidth]{msgsize.pdf}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\textwidth]{msgoverhead.pdf}
\end{figure}
