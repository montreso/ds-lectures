...
\begin{column}{0.4\textwidth}
	\includegraphics[width=\textwidth]{figs/14/primary-backup}
\end{column}
...
\onslide<1|handout:1>
\begin{figure}
\includegraphics[width=0.7\textwidth]{figs/14/quorum1}
\end{figure}
\onslide<2|handout:2>
\begin{figure}
\includegraphics[width=0.7\textwidth]{figs/14/quorum2}
\end{figure}
\end{overprint}
\end{frame}
...
\begin{figure}
\includegraphics[width=0.9\textwidth, trim=0 20 0 60]{figs/14/messages0}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\textwidth, trim=0 20 0 60]{figs/14/messages3}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\textwidth, trim=0 20 0 60]{figs/14/messages4}
\end{figure}
...
\begin{figure}
	\includegraphics[width=0.8\textwidth]{figs/14/nfs}
\end{figure}	
...
\begin{figure}
	\includegraphics[width=0.8\textwidth]{figs/14/andrew1}
\end{figure}	
