...
\includegraphics[width=\textwidth]{figs/02/client-server.png}
\end{column}
\end{columns}
...
\includegraphics[width=0.8\textwidth]{figs/02/multi-tier.png}	
\end{frame}
...
\begin{figure}
\includegraphics[width=\textwidth]{figs/02/cluster.png}	
\end{figure}
